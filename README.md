# D2 - Проект NewsPaper. Итоговое задание

Что в данном задании?
...
Эти модели реализовывают методы:
...
Что нужно было сделать в консоли Django?
...
Созданное  приложение вместе с файлом с командами commands-homework.txt загружено в репозиторий.
